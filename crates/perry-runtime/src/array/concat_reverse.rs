...
pub extern "C" fn js_array_concat(
    ...
    unsafe {
        ...
        if !dest_resolved.is_null() && dest_resolved as *const _ != src {
            ...
            // GC_STORE_AUDIT(BARRIERED): concat bulk append is followed by exact layout rebuild.
...
pub extern "C" fn js_array_reverse(arr: *mut ArrayHeader) -> *mut ArrayHeader {
    ...
    unsafe {
        ...
        while i < j {
            ...
            // GC_STORE_AUDIT(BARRIERED): reverse swaps are followed by layout rebuild.
...
pub extern "C" fn js_array_fill(arr: *mut ArrayHeader, value: f64) -> *mut ArrayHeader {
    ...
    unsafe {
        ...
        let elements = (arr as *mut u8).add(std::mem::size_of::<ArrayHeader>()) as *mut f64;
        for i in 0..len {
            // GC_STORE_AUDIT(BARRIERED): fill writes are followed by layout rebuild.
...
pub extern "C" fn js_array_fill_range(
    ...
    unsafe {
        ...
        let elements = (arr as *mut u8).add(std::mem::size_of::<ArrayHeader>()) as *mut f64;
        for i in s..e {
            // GC_STORE_AUDIT(BARRIERED): ranged fill writes are followed by layout rebuild.
